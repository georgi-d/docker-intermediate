...
Step 3/13 : LABEL description "This is an example of a Node API server with connection to MongoDB."
...
As an interim step, we can verify our image by using a host database.

NOTE: This step is not neccessary to complete the lab. If you have mongodb installed locally, feel free to give this a shot!

 In other words, our app will be connecting to the host database from a container. This is good for development. In production, you'll be using managed database such as AWS RDS or Compose or mLabs or a database in a separate (second) container.
...
or, on Windows machines, look into:
